...
export default function HomePage() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-stone-900 via-stone-800 to-amber-900 text-white py-20 lg:py-28">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'%23ffffff\' fill-opacity=\'0.05\'%3E%3Cpath d=\'M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-50" />
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-amber-300 text-sm font-medium mb-2">Established in {COMPANY.established}</p>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4">
            {COMPANY.name}
          </h1>
          <p className="text-xl text-amber-100 mb-2">{COMPANY.tagline}</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-3 bg-amber-600 text-white font-semibold rounded-lg hover:bg-amber-500 transition-colors"
            >
              Get Free Quote
            </Link>
            <a
              href={`tel:${COMPANY.phone}`}
              className="inline-flex items-center justify-center px-8 py-3 bg-white text-stone-900 font-semibold rounded-lg hover:bg-stone-100 transition-colors"
            >
              Call Now
            </a>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-stone-800 mb-6 text-center">Welcome to {COMPANY.name}</h2>
          <div className="max-w-3xl mx-auto text-center text-stone-600 space-y-4">
            <p>
      ...
      <section className="py-16 bg-stone-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-stone-800 mb-12 text-center">Our Core Services</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {coreServices.map((service) => (
              ...
              >
                <h3 className="font-semibold text-stone-800 mb-3">{service.title}</h3>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-stone-800 mb-12 text-center">Why Choose {COMPANY.name}</h2>
      ...
      <section className="py-16 bg-stone-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-stone-800 mb-6 text-center">Our Services</h2>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-stone-800 mb-12 text-center">Our Recent Projects</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {["Gypsum ceiling", "Glass partitions", "Office cabins", "Aluminium doors"].map((label, i) => (
              <Link
                key={label}
                href="/gallery"
                className="group aspect-[4/3] bg-stone-200 rounded-lg overflow-hidden hover:opacity-90 transition-opacity"
              >
                <div className="w-full h-full bg-gradient-to-br from-stone-300 to-stone-400 flex items-center justify-center">
                  <span className="text-stone-600 text-sm font-medium group-hover:text-stone-800">
                    {label}
                  </span>
                </div>
              </Link>
      ...
      <section className="py-16 bg-stone-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-stone-800 mb-6">Our Service Area</h2>
      ...
      <section className="py-16 bg-amber-600 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href={`tel:${COMPANY.phone}`}
            className="inline-flex items-center justify-center px-8 py-4 bg-white text-amber-700 font-semibold rounded-lg hover:bg-amber-50 transition-colors"
          >
            Call: {COMPANY.phone}
          </a>
        </div>
