  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        {/* Strengths */}
        <section>
          <h2 className="text-2xl font-bold text-stone-800 mb-6">Our Strengths</h2>
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {strengths.map((s) => (
              <li key={s} className="flex items-center gap-2 text-stone-600">
        ...
        {/* Experience */}
        <section>
          <h2 className="text-2xl font-bold text-stone-800 mb-6">Our Experience</h2>
          <p className="text-stone-600 mb-4">
            Since {COMPANY.established}, {COMPANY.name} has worked on:
          </p>
          <ul className="space-y-2">
            {experience.map((e) => (
              <li key={e} className="flex items-center gap-2 text-stone-600">
